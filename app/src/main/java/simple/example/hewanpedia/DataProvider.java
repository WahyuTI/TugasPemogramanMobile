...
public class DataProvider {
    ...
    private static List<Kurakura> initDataKurakura(Context ctx) {
        ...
        kurakuras.add(new Kurakura("Kura-kura sulcata", "Afrika",
                "Kura-kura Afrika yang dipacu, juga disebut kura-kura sulcata, ", R.drawable.sulkata));
        kurakuras.add(new Kurakura("Kura-kura Hermann", "Hermann timur.",
                "Kura-kura Hermann adalah spesies dalam genus Testudo. ", R.drawable.hermani));
        kurakuras.add(new Kurakura("Agrionemys horsfieldii", "Rusia",
                "Kura-kura rusia, juga dikenal dengan nama kura-kura Horsfield atau kura-kura asia tengah,  ", R.drawable.rusia));
        kurakuras.add(new Kurakura("Kura-kura yunani", "yunani",
                "Kura-kura Yunani, juga dikenal sebagai kura-kura paha,", R.drawable.yunanai));
        kurakuras.add(new Kurakura("Kura-kura pardalis", "sabana Afrika",
                "Kura-kura macan tutul adalah kura-kura besar dan ditandai menarik ", R.drawable.pardalis));
        kurakuras.add(new Kurakura("Kura-kura bintang india", "india",
                "Kura-kura bintang India adalah spesies kura-kura terancam yang ditemukan di daerah kering dan menggosok hutan di India,", R.drawable.inda));
        return kurakuras;
    }
